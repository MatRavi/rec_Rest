        ...
        <Router className={styles.m_b}>
            <div className={styles.row && styles.textAli && styles.menu}>
                <div className={styles.lin}>
                    ...
                    <Link to='/' className={styles.link} id={styles.titulo}>Mario's</Link>
                    <Link to='/conta' className={styles.link}>Contato</Link> 
                </div>
            </div>
      <Routes>
        <Route path='/login' element={<Login enviarParaMenu={handleCodCli}/>} />
