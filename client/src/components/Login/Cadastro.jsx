...
return(<>
    ...
    <div className={styles.form_group && styles.mb_3}>
        ...
        <input type="text" id="nome" className={`${styles.form_control}`} placeholder="Nome Completo" required />
    </div>
    <div className={styles.form_group && styles.mb_3}>
        <label className={styles.label} htmlFor="CPF">CPF*</label>
        <input type="text" id="cpf" className={`${styles.form_control}`} placeholder="CPF" required />
    </div>
    <div className={styles.form_group && styles.mb_3}>
        <label className={styles.label} htmlFor="fone">Telefone*</label>
        <input type="text" id="fone" className={`${styles.form_control}`} placeholder="Telefone" required />
    </div>
    <div className={styles.form_group && styles.mb_3}>
        <label className={styles.label} htmlFor="nasc">Data de Nascimento*</label>
        <input type="date" id="nasc" className={`${styles.form_control}`} required />
    </div>
    <div className={styles.form_group && styles.mb_3}>
        <label className={styles.label} htmlFor="email">Email*</label>
        <input type="email" id="email" className={`${styles.form_control}`} placeholder="Email" required />
    </div>

    <div className={styles.form_group && styles.mb_3}>
        <label className={styles.label} htmlFor="password">Senha*</label>
        <input type="password" id="password" className={`${styles.form_control}`} maxLength="50" placeholder="Senha" required />
            <button className={`${styles.btn_mostrinfo}`} onClick={mostrar} id="mostra">
                <FaEye/>
            </button>
    </div>
    
    <div className={styles.form_group && styles.mb_3}>
        <label className={styles.label} htmlFor="password2">Repetir Senha*</label>
        <input type="password" id="password2" className={`${styles.form_control}`} maxLength="50" placeholder="Senha" required />
    </div>
    
    <div className={styles.form_group && styles.mb_3}>
        <label className={styles.label} htmlFor="CEP">CEP*</label>
        <input type="text" id="cep" onBlur={Cep} className={`${styles.form_control}`} placeholder="cep" required />
    </div>

    <div className={styles.form_group && styles.mb_3} >
        <label className={styles.label} htmlFor="Estado">Estado*</label>
        <select className={`${styles.form_control}`} onChange={Estado} id="estados_list"></select>
    </div>
   ...
   <div className={styles.form_group && styles.mb_3}>
        ...
        <input type="text" id="bairro" className={`${styles.form_control}`} placeholder="bairro" required />
    </div>

    <div className={styles.form_group && styles.mb_3}>
        <label className={styles.label} htmlFor="Rua">Rua*</label>
        <input type="text" id="rua" className={`${styles.form_control}`} placeholder="Rua" required />
    </div>

    <div className={styles.form_group && styles.mb_3}>
        <label className={styles.label} htmlFor="Número">Número</label>
        <input type="number" id="numero" className={`${styles.form_control}`} placeholder="Número" required />
    </div>

    <div className={styles.form_group && styles.mb_3}> 
        <label className={styles.label} htmlFor="Complemento">Complemento</label>
        <input type="text" id="complemento" className={`${styles.form_control}`} placeholder="Complemento" required />
    </div>
    ...
    <div className={`${styles.form_group}`}>
        <button id="cadastrar" className={`${styles.form_control} ${styles.btn} ${styles.btn_info}`}>
            Cadastrar-se
        </button>
    </div>
</>)
